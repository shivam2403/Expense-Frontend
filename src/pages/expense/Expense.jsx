...
const Expense = () => {
  ...
  const handleAdd=async(e)=>{
    ...
    try {
      const res=await axios.post('https://expense-backend-xz7w.onrender.com/api/v1/expense',{
        amount:amount,
        category:category,
      ...
      const resp = await axios.get(`https://expense-backend-xz7w.onrender.com/api/v1/expense/by-user/${user._id}`);
      setExp(resp.data);
