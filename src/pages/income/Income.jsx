...
const Income = () => {
  ...
  const handleAdd=async(e)=>{
    ...
    try {
      const res=await axios.post('https://expense-backend-xz7w.onrender.com/api/v1/income',{
        amount:amount,
        category:category,
      ...
      const resp = await axios.get(`https://expense-backend-xz7w.onrender.com/api/v1/income/by-user/${user._id}`);
      setInc(resp.data);
